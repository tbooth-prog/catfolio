...
const disclosure = tv({
  base: "group min-w-50 font-sans rounded-lg text-neutral-900 dog:text-neutral-200",
});

const chevron = tv({
  base: "w-4 h-4 text-neutral-500 dog:text-neutral-400 transition-transform duration-200 ease-in-out",
  variants: {
    isExpanded: {
