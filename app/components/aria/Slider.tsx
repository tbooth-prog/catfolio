...
const trackStyles = tv({
  ...
  variants: {
    ...
    isDisabled: {
      false:
        "bg-neutral-300 dog:bg-neutral-700 forced-colors:bg-[ButtonBorder]",
      true: "bg-neutral-200 dog:bg-neutral-800 forced-colors:bg-[ButtonBorder]",
    },
  },
});
...
const fillStyles = tv({
  ...
  variants: {
    ...
    isDisabled: {
      ...
      true: "bg-neutral-300 dog:bg-neutral-600 forced-colors:bg-[GrayText]",
    },
  },
});
...
const thumbStyles = tv({
  extend: focusRing,
  base: "w-4.5 h-4.5 group-orientation-horizontal:mt-5 group-orientation-vertical:ml-2.5 rounded-full bg-neutral-50 dog:bg-neutral-900 border border-neutral-700 dog:border-neutral-300",
  variants: {
    isDragging: {
      true: "bg-neutral-700 dog:bg-neutral-300 forced-colors:bg-[ButtonBorder]",
    },
    isDisabled: {
      true: "border-neutral-300 dog:border-neutral-700 forced-colors:border-[GrayText]",
    },
  },
});
...
export function Slider<T extends number | number[]>({
  ...
  return (
    ...
    >
      <Label>{label}</Label>
      <SliderOutput className="text-sm text-neutral-500 dog:text-neutral-400 orientation-vertical:hidden">
        {({ state }) =>
