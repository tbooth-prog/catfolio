...
const cellStyles = tv({
  ...
  variants: {
    isSelected: {
      false:
        "text-neutral-900 dog:text-neutral-200 hover:bg-neutral-200 dog:hover:bg-neutral-700 pressed:bg-neutral-300 dog:pressed:bg-neutral-600",
...
export function CalendarHeader() {
  ...
  return (
    <header className="flex items-center gap-1 pb-4 px-1 border-box">
      ...
      <Heading className="flex-1 font-sans font-semibold [font-variation-settings:normal] text-base text-center mx-2 my-0 text-neutral-900 dog:text-neutral-200" />
