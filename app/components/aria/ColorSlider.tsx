...
const trackStyles = tv({
  ...
  variants: {
    ...
    isDisabled: {
      true: "bg-neutral-300 dog:bg-neutral-800 forced-colors:bg-[GrayText]",
    },
  },
});
...
export function ColorSlider({ label, ...props }: ColorSliderProps) {
  return (
    ...
    >
      <Label>{label}</Label>
      <SliderOutput className="text-sm text-neutral-500 dog:text-neutral-400 font-medium orientation-vertical:hidden" />
      <SliderTrack
