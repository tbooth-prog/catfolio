      ...
      {({ percentage, valueText, isIndeterminate }) => (
        <>
          <div className="flex justify-between gap-2">
            <Label>{label}</Label>
            <span className="text-sm text-neutral-600 dog:text-neutral-400">
              {valueText}
            </span>
          </div>
          <div className="max-w-full h-2 rounded-full bg-neutral-300 dog:bg-neutral-700 outline outline-1 -outline-offset-1 outline-transparent relative overflow-hidden">
            <div
