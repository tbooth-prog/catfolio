    ...
    >
      ...
      <FieldGroup className="min-w-52 w-auto cursor-text disabled:cursor-default">
        <div className="flex-1 w-fit flex items-center overflow-x-auto overflow-y-clip [scrollbar-width:none]">
          ...
          <span
            aria-hidden="true"
            className="text-neutral-800 dog:text-neutral-200 forced-colors:text-[ButtonText] group-disabled:text-neutral-200 dog:group-disabled:text-neutral-600 forced-colors:group-disabled:text-[GrayText]"
          >
            –
          </span>
