  ...
  return (
    ...
    >
      ...
      <FieldGroup>
        <SearchIcon
          aria-hidden
          className="w-4 h-4 ml-2 text-neutral-500 dog:text-neutral-400 forced-colors:text-[ButtonText] group-disabled:text-neutral-200 dog:group-disabled:text-neutral-600 forced-colors:group-disabled:text-[GrayText]"
        />
        <Input
