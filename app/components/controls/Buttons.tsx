...
const buttonClasses = tv({
  ...
  variants: {
    variant: {
      ...
      quiet:
        "border-0 bg-transparent hover:bg-neutral-200 pressed:bg-neutral-300 text-neutral-800 dog:hover:bg-neutral-700 dog:pressed:bg-neutral-600 dog:text-neutral-100",
    },
    isDisabled: {
  ...
  return (
    <AriaButton
      ...
      className={composeRenderProps(props.className, (className, renderProps) =>
        buttonClasses({ ...renderProps, variant: props.variant, className }),
      )}
    >
...
export function LinkButton(props: SharedButtonProps & LinkProps) {
  ...
  const { buttonProps } = useButton(
    { elementType: "a", href: typeof to === "string" ? to : undefined },
    ref,
  );
